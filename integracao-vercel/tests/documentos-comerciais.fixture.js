...
import {MODELO_CONTRATO} from '../src/contrato-modelo.js';
...
const context={MODELO_CONTRATO,dadosContrato,MODELO_MEMORIAL_NUCLEO:'',MODELO_MEMORIAL_DESCRITIVO:'',aplicarCondicionais:x=>x,expandirLacos:(html,d)=>html.replace(/\{\{elaboracao\.(\w+)\}\}/g,(_,k)=>d.elaboracao[k]),escaparHtml:x=>x};
